                                ...
                                (
                                    <>
                                        ...
                                        <div className='flex justify-end mt-4'>
                                            <button onClick={() => nav('/editor/addTask')} className='relative inline-flex px-8 py-3 font-semibold text-xl traking-widset bg-slate-400  hover:bg-slate-600 hover:text-white rounded-full mr-10 bg-gray-300'>ADD</button>
                                        </div>
                                    </>
                                )
                        }
