...
const Employe_Details = () => {
    ...
    const {employeeId,firstName,lastName,email,gender,status,leadId,leadName}=useContext(Context);
    return (
            ...
            <div className="flex flex-col w-1/3">
                <div className="container w-10/12 rounded-md bg-white flex flex-col ml-12 mt-5 shadow-2xl">
                    <div className=" flex flex-col justify-center items-center py-2">
                        ...
                        <h3 className="font-bold text-xl text-slate-800 mb-1 mt-1 ">{firstName.fName+' '+lastName.lName}</h3>
                    ...
                    <div className="bg-slate-100 py-4 ml-4 mr-4 rounded-md shadow-xl">
                        <div className="flex flex-row justify-between mb-1">
                            ...
                            {/* <CiEdit className="mr-10 text-2xl font-medium cursor-pointer rounded-full border-solid border-2 bg-amber-400" onClick={()=>nav('/editor/editEmployee')} /> */}
                        </div>
                        <div className="flex flex-row justify-between mb-1">
                            <span className="font-medium text-1xl px-8">{status.status}</span>
                        ...
                        <div className="flex flex-row justify-between">
                            <span className="font-medium text-1xl px-8">{leadName.l_name}</span>
                        </div>
                    </div>
                    <div className="flex flex-col mt-2 py-4">
                        <span className="font-normal text-1xl px-10 mb-1">Gender</span>
                        <span className="font-medium text-1xl px-10 mb-1">{gender.gen}</span>
                        <span className="font-normal text-1xl px-10 mb-1">Email</span>
                        <span className="font-medium text-1xl px-10 mb-1">{email.email}</span>
                    </div>
                </div>
